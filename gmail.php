...
$mail->msgHTML("<b>Chào {$_POST['ten']}!</b><br/> Click vao <a href='http://localhost:81/nhatnghe/website/webtest/kichhoat.php?makh=$mangaunhien'>day</a> de kich hoat"); //
...
if (!$mail->send()) {
    ...
    echo "Message sent! Vui lòng truy cập vào gmail của bạn để xác nhận tài khoản.";
}
